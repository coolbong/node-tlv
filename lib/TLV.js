...
TLV.prototype.print = function(indent) {
    ...
    if(this.info.encoding == 'constructed') {
        ...
        if (this.desc) {
            console.log(prefix + tab + this.desc());
        }
    }
};
...
function main() {
    //var data = '9F5C089F4005';
    //var data = '9F02069F03069F1A0295055F2A029A039C019F37049F35019F45029F4C089F34039F21039F7C14';
    //var data = '910A8A0295059F37049F4C089F02069F0306';
    //var dol = new DOL(data);
    //dol.print();

    DOL.parse('9F5C089F4005').print();
    console.log();
    DOL.parse('9F02069F03069F1A0295055F2A029A039C019F37049F35019F45029F4C089F34039F21039F7C14').print();
    console.log();
    DOL.parse('910A8A0295059F37049F4C089F02069F0306').print();
    console.log();
}
